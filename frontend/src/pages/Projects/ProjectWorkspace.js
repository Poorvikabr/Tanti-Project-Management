...
export const ProjectWorkspace = () => {
  ...
  useEffect(() => {
    if (id) {
      // Load saved column widths and row heights
  ...
  const updateScopeItem = (srcIndex, field, value) => {
    setScopeItems((prev) => prev.map((it, i) => (i === srcIndex ? { ...it, [field]: value } : it)));
  };
    ...
    <div className="space-y-6" data-testid="project-workspace">
      ...
      <Tabs defaultValue="overview" className="w-full" data-testid="project-tabs">
        <TabsList className="grid w-full grid-cols-5 lg:grid-cols-9">
          ...
          <TabsTrigger value="milestones" onClick={() => navigate('/milestones')}>Milestones</TabsTrigger>
        ...
        <TabsContent value="design" className="mt-6">
          <DesignDeliverables projectId={parseInt(id)} />
        </TabsContent>
